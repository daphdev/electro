...
function useEmployeeUpdateViewModel(id: number) {
  ...
  if (!employee && employeeResponse) {
    ...
    const formValues: typeof form.values = {
      ...
      'user.address.provinceId': employeeResponse.user.address.province ? String(employeeResponse.user.address.province.id) : '',
      'user.address.districtId': employeeResponse.user.address.district ? String(employeeResponse.user.address.district.id) : '',
